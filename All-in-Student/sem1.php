                    ...
                    <div class="row">
                      ...
                      <div id="dyf">
                         ...
                         <div class="row">
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s1m1" class="form-control" id="sem1m1"/>
                                 <label for="sem1m1" class="form-label">Marks1</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s1m2"  class="form-control" id="sem1m2"/>
                                 <label for="sem1m2" class="form-label">Marks2</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s1m3" class="form-control" id="sem1m3"/>
                                 <label for="sem1m3" class="form-label">Marks3</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s1m4" class="form-control" id="sem1m4"/>
                                 <label for="sem1m4" class="form-label">Marks4</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s1m5" class="form-control" id="sem1m5"/>
                                 <label for="sem1m5" class="form-label">Marks5</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s1m6" class="form-control" id="sem1m6"/>
                           ...
                           <div class="row">
                             <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="text" name="sgpa1" class="form-control" id="sg1" required/>
                                   <label for="sg1" class="form-label">SGPA</label>
                                 </div>
                               </div>
                               <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="text" name="cgpa1" class="form-control" id="cg1" required/>
