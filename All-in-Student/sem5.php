                    ...
                    <div class="row">
                      ...
                      <div>
                         ...
                         <div class="row">
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s5m1" class="form-control" id="sem5m1"/>
                                 <label for="sem5m1" class="form-label">Marks1</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s5m2"  class="form-control" id="sem5m2"/>
                                 <label for="sem5m2" class="form-label">Marks2</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s5m3" class="form-control" id="sem5m3"/>
                                 <label for="sem5m3" class="form-label">Marks3</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s5m4" class="form-control" id="sem5m4"/>
                                 <label for="sem5m4" class="form-label">Marks4</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s5m5" class="form-control" id="sem5m5"/>
                                 <label for="sem5m5" class="form-label">Marks5</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s5m6" class="form-control" id="sem5m6"/>
                           ...
                           <div class="row">
                             <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="text" name="sgpa5" class="form-control" id="sg5" required/>
                                   <label for="sg5" class="form-label">SGPA</label>
                                 </div>
                               </div>
                               <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="text" name="cgpa5" class="form-control" id="cg5" required/>
