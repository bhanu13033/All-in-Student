                    ...
                    <div class="row">
                      ...
                      <div>
                         ...
                         <div class="row">
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s2m1" class="form-control" id="sem2m1"/>
                                 <label for="sem2m1" class="form-label">Marks1</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s2m2"  class="form-control" id="sem2m2"/>
                                 <label for="sem2m2" class="form-label">Marks2</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s2m3" class="form-control" id="sem2m3"/>
                                 <label for="sem2m3" class="form-label">Marks3</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s2m4" class="form-control" id="sem2m4"/>
                                 <label for="sem2m4" class="form-label">Marks4</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s2m5" class="form-control" id="sem2m5"/>
                                 <label for="sem2m5" class="form-label">Marks5</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s2m6" class="form-control" id="sem2m6"/>
                           ...
                           <div class="row">
                             <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="text" name="sgpa2" class="form-control" id="sg2" required/>
                                   <label for="sg2" class="form-label">SGPA</label>
                                 </div>
                               </div>
                               <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="text" name="cgpa2" class="form-control" id="cg2" required/>
