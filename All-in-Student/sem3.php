                    ...
                    <div class="row">
                      ...
                      <div>
                         ...
                         <div class="row">
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s3m1" class="form-control" id="sem3m1"/>
                                 <label for="sem3m1" class="form-label">Marks1</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s3m2"  class="form-control" id="sem3m2"/>
                                 <label for="sem3m2" class="form-label">Marks2</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s3m3" class="form-control" id="sem3m3"/>
                                 <label for="sem3m3" class="form-label">Marks3</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s3m4" class="form-control" id="sem3m4"/>
                                 <label for="sem3m4" class="form-label">Marks4</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s3m5" class="form-control" id="sem3m5"/>
                                 <label for="sem3m5" class="form-label">Marks5</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s3m6" class="form-control" id="sem3m6"/>
                           ...
                           <div class="row">
                             <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="text" name="sgpa3" class="form-control" id="sg3" required/>
                                   <label for="sg3" class="form-label">SGPA</label>
                                 </div>
                               </div>
                               <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="text" name="cgpa3" class="form-control" id="cg3" required/>
