                    ...
                    <div class="row">
                      ...
                      <div>
                         ...
                         <div class="row">
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s8m1" class="form-control" id="sem8m1"/>
                                 <label for="sem8m1" class="form-label">Marks1</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s8m2"  class="form-control" id="sem8m2"/>
                                 <label for="sem8m2" class="form-label">Marks2</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s8m3" class="form-control" id="sem8m3"/>
                                 <label for="sem8m3" class="form-label">Marks3</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s8m4" class="form-control" id="sem8m4"/>
                                 <label for="sem8m4" class="form-label">Marks4</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s8m5" class="form-control" id="sem8m5"/>
                                 <label for="sem8m5" class="form-label">Marks5</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s8m6" class="form-control" id="sem8m6"/>
                           ...
                           <div class="row">
                             <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="text" name="sgpa8" class="form-control" id="sg8" required/>
                                   <label for="sg8" class="form-label">SGPA</label>
                                 </div>
                               </div>
                               <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="text" name="cgpa8" class="form-control" id="cg8" required/>
