                    ...
                    <div class="row">
                      ...
                      <div id="dyf">
                         ...
                         <div class="row">
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s4m1" class="form-control" id="sem4m1"/>
                                 <label for="sem4m1" class="form-label">Marks1</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s4m2"  class="form-control" id="sem4m2"/>
                                 <label for="sem4m2" class="form-label">Marks2</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s4m3" class="form-control" id="sem4m3"/>
                                 <label for="sem4m3" class="form-label">Marks3</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s4m4" class="form-control" id="sem4m4"/>
                                 <label for="sem4m4" class="form-label">Marks4</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s4m5" class="form-control" id="sem4m5"/>
                                 <label for="sem4m5" class="form-label">Marks5</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s4m6" class="form-control" id="sem4m6"/>
                           ...
                           <div class="row">
                             <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="text" name="sgpa4" class="form-control" id="sg4" required/>
                                   <label for="sg4" class="form-label">SGPA</label>
                                 </div>
                               </div>
                               <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="text" name="cgpa4" class="form-control" id="cg4" required/>
...
if(isset($_POST['sub']) ){
      ...
      $q = " SELECT*FROM sem3 WHERE usn = '$usn'" ;
      ...
      {
        $up="UPDATE sem3 SET name ='$name', usn ='$usn',sub1='$sub11',mark1='$mark11',sub2='$sub21',mark2='$mark21',sub3='$sub31',mark3='$mark31',sub4='$sub41',mark4='$mark41',sub5='$sub51',mark5='$mark51',sub6='$sub61',mark6='$mark61',cgpa='$cgpa1',sgpa='$sgpa1',bl='$bl1' WHERE usn= '$usn'";
        $result2 = mysqli_query($conn,$up);
        if($result2){
