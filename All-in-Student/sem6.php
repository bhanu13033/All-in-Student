                    ...
                    <div class="row">
                      ...
                      <div>
                         ...
                         <div class="row">
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s6m1" class="form-control" id="sem6m1"/>
                                 <label for="sem6m1" class="form-label">Marks1</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s6m2"  class="form-control" id="sem6m2"/>
                                 <label for="sem6m2" class="form-label">Marks2</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s6m3" class="form-control" id="sem6m3"/>
                                 <label for="sem6m3" class="form-label">Marks3</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s6m4" class="form-control" id="sem6m4"/>
                                 <label for="sem6m4" class="form-label">Marks4</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s6m5" class="form-control" id="sem6m5"/>
                                 <label for="sem6m5" class="form-label">Marks5</label>
                               </div>
                             </div>  
                             <div class="col-md-2 mb-3">
                               <div class="form-outline">
                                 <input type="text" name="s6m6" class="form-control" id="sem6m6"/>
                           ...
                           <div class="row">
                             <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="text" name="sgpa6" class="form-control" id="sg6" required/>
                                   <label for="sg6" class="form-label">SGPA</label>
                                 </div>
                               </div>
                               <div class="col-md-4 mb-3">
                                 <div class="form-outline">
                                   <input type="text" name="cgpa6" class="form-control" id="cg6" required/>
